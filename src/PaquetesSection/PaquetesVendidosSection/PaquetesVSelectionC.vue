<template>
  <div class="paquetev-section">
    <div class="section-header">
      ...
      <div class="filtro-container">
        <div class="filtro-opciones">
          ...
          <button
            class="filtro-btn"
            :class="{ active: filtroActivo === 'pasadas' }"
          ...
          <button
            class="filtro-btn"
            :class="{ active: filtroActivo === 'futuras' }"
            @click="aplicarFiltro('futuras')"
          >
            Futuras
          </button>
        </div>
    ...
    <div v-if="!loading && !error && paquetesvFiltrados.length === 0" class="no-paquetesv-filtro">
      <p>No hay paquetes activos {{ textoFiltroActivo }}</p>
    </div>
  </div>
</template>

<script setup>
import { usePaquetesVSelection } from './JS/PaquetesVSelectionC'
